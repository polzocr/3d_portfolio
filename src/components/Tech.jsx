...
const SkillCard = ({name,icon, index}) => {
  return (
    <Tilt className="">
      <motion.div variants={fadeIn("right","spring", 0.5*index, 0.75)}  className="flex flex-col dark:hover:bg-gray-700  dark:bg-gray-200 border-gray-800 dark:border-white border-4 rounded-lg p-3 sm:m-2 m-4 hover:bg-gray-800 hover:text-gray-200 transform hover:-translate-y-1 hover:scale-10 items-center justify-center">
